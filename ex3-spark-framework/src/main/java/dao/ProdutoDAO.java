...
public class ProdutoDAO extends DAO {    
    ...
    public boolean insert(Produto produto) {
        ...
        try {
            ...
            st.setDouble(2, (double)produto.getPreco());
    ...
    public List<Produto> getOrderByID() { return get("id"); }
    public List<Produto> getOrderByDescricao() { return get("descricao"); }
    public List<Produto> getOrderByPreco() { return get("preco"); }
    public List<Produto> get() { return get(""); }
